...
interface AdminDraftOrder {
  id: string
  display_id?: number
  status?: string
  metadata?: DraftOrderMetadata | null
  [key: string]: unknown
}

const DraftOrderMetadataWidget = ({ data }: DetailWidgetProps<AdminDraftOrder>) => {
  const metadata = data.metadata as DraftOrderMetadata | null
  ...
  return (
    <Container className="divide-y p-0">
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <Badge color="orange">Brouillon v{metadata.version || '1.0'}</Badge>
      </div>
...
export const config = defineWidgetConfig({
  zone: "draft_order.details.side.before",
})

export default DraftOrderMetadataWidget
